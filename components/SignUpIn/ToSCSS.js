...
const ToS = () => {
  return (
    <>
      <HeaderT>Agreement To Terms Of Services</HeaderT>
      <Para>
        These Terms govern your access to and use of BR Maxing. Our Services are
        ...
        policies (including, without limitation, BR Maxing Privacy Policy), and
        procedures that may be published from time to time by us. You agree that
        we may automatically upgrade our Services, and the Agreement will apply
        to any upgrades. Please read the Agreement carefully before accessing or
        using our Services. By accessing or using any part of our Services, you
        agree to become bound by the Agreement. If you do not agree to all the
        terms of the Agreement, then you may not access or use our Services.
      </Para>

      <HeaderT1>Contents:</HeaderT1>

      <Para>
        1. Your Account<br></br>
        <br></br>
        2. Responsibility of Visitors and Users<br></br>
        <br></br>
        3. Fees, Payment, and Renewal<br></br>
        a. Fees for Paid Services<br></br>
        b. Payment<br></br>
        c. Fee Changes<br></br>
        d. Refunds<br></br>
        <br></br>
        <br></br>
        4. General Representation and Warranty<br></br>
        5. Copyright Infringement<br></br>
        <br></br>
        6. Intellectual Property<br></br>
        <br></br>
        7. Changes<br></br>
        <br></br>
        8. Jurisdiction and Applicable Law<br></br>
        <br></br>
        9. User Right Possesion<br></br>
        <br></br>
        10. Miscellaneous<br></br>
        <br></br>
      </Para>
      <HeaderT1>1. Your Account:</HeaderT1>
      <Para>
        ...
        and keep the information current. This is important because sometimes we
        may need to send you notable updates (for example, about changes to our
        Terms of Service or Privacy Policy), or we may want to let you know
        about and make informed choices in response to legal inquiries or
        complaints. You will be solely responsible and liable for any activity
        that occurs under your account. You are responsible for keeping your
        account information up-to-date and for keeping your password secure. You
      ...
      <HeaderT1>2. Responsibility of Visitors and Users:</HeaderT1>
      ...
      <Para>
        ...
        anyone else and are not responsible for any use or effects of such
        Content. So, for example: We do not endorse any Content or represent
        that Content is accurate, useful, or non-harmful. Content could be
        offensive, indecent, or objectionable; include technical inaccuracies,
        typographical mistakes, or other errors; or violate or infringe the
        privacy, publicity rights, intellectual property rights (see our
        Copyright Infringement and DMCA Policy section to submit copyright
        complaints), or other proprietary rights of third parties. If you post
        Content, comment on a website, or otherwise make (or allow any third
        party to make) Content available on our Services, you are entirely
        responsible for the Content, and any harm resulting from, that Content
        or your conduct. We disclaim any responsibility for any harm resulting
        from anyone’s use, purchase, or downloading of Content. If you access or
        use any Content, you are responsible for taking precautions as necessary
        to protect yourself and your computer systems from viruses, worms,
        Trojan horses, and other harmful or destructive content. The existence
        of a link to or from one of our Services does not represent or imply
        that we endorse such website. When using these links, You are
...
<Para>
The Agreement does not transfer from BR Maxing to you any intellectual
property, and all right, title, and interest in and to such property will remain (as
between the parties) solely with BR Maxing. Any trademarks, service marks,
graphics, and logos used in connection with our Services, are trademarks or
registered trademarks of BR Maxing. Other trademarks, service marks,
...
reproduce or otherwise use any BR Maxing or third party trademarks. 
</Para>
...
BR Maxing excluding its conflict of law provisions. The proper venue for
...
<HeaderT1>
9. Slav- User Right Possesion:
</HeaderT1>
<Para>
  The agreements allows the owner of BR Maxing to have the rights over everything you 
  posses in life. By agreeing to the Terms of Services, you agree to give your life 
  away to the owner of this website eternally. Once you make an account; the beginning of this contract
  will be applicable by Law.
</Para>
...
<Para>
The Agreement constitutes the entire agreement between BR Maxing and
...
to, and agrees to be bound by, its terms and conditions; BR Maxing may
